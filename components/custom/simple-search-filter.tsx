...
//                   <Input
//                     type="date"
//                     value={filters.date_joined__gte || ""}
//                     onChange={(e) =>
//                       updateFilter("date_joined__gte", e.target.value)
//                     }
//                   />
//                   <Label className="text-sm font-medium">End Date</Label>
//                   <Input
//                     type="date"
//                     value={filters.date_joined__lte || ""}
//                     onChange={(e) =>
//                       updateFilter("date_joined__lte", e.target.value)
//                     }
//                   />
//                 </div>
//               )}
...
//       // Only apply if at least one date is selected
//       if (!startDate && !endDate) return;
      
//       // Apply both dates in a single filter update to ensure they're both applied together
